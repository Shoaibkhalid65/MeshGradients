...
val AquaBlue = Color(0xFF4ED9F5)
val SoftLavender = Color(0xFFB8B4FF)
val DeepNavy = Color(0xFF2E2B87)
val CoralPink = Color(0xFFFF8FA3)
val SkyCyan = Color(0xFF76E5FC)
val BrightBlue = Color(0xFF3A86FF)
val LightLilac = Color(0xFFCDB4DB)
val PeachCoral = Color(0xFFFFB4A2)

//Sunset Bliss XL
val PeachPink = Color(0xFFFF9A8B)
val WarmPink = Color(0xFFFF6A88)
val LightRose = Color(0xFFFF99AC)
val PaleOrange = Color(0xFFFFD4A3)
val SunYellow = Color(0xFFFECF6A)
val Tangerine = Color(0xFFFF7E5F)
val SoftAmber = Color(0xFFFEB47B)
val WarmSand = Color(0xFFFDD692)
val SalmonGlow = Color(0xFFFFB997)

//Cyber Neon XL
val MintNeon = Color(0xFF00F5A0)
val CyanNeon = Color(0xFF00D9F5)
val VioletNeon = Color(0xFF7A5FFF)
val MagentaPink = Color(0xFFFF4F81)
val ElectricYellow = Color(0xFFFFD300)
val LimeMint = Color(0xFF05FFA1)
val AquaLaser = Color(0xFF14F7FF)
val NeonPurple = Color(0xFFA64DFF)
val NeonPink = Color(0xFFFF6FD8)

//Nature Serenity XL
val MintGreen = Color(0xFFA8E6CF)
val PastelGreen = Color(0xFFDCEDC1)
val PeachBeige = Color(0xFFFFD3B6)
val SoftPink = Color(0xFFFFAAA5)
val BlushCoral = Color(0xFFFF8B94)
val AquaPastel = Color(0xFFB5EAD7)
val FreshMint = Color(0xFFC7FFD8)
val SoftLemon = Color(0xFFFFF5BA)
val LightSpringGreen = Color(0xFFE2F0CB)

//Aurora Glow XL
val AquaGlow = Color(0xFF5EFCE8)
val PurpleGlow = Color(0xFF736EFE)
val PeachGlow = Color(0xFFFAD0C4)
val RoseGlow = Color(0xFFFF9A9E)
val PinkGlow = Color(0xFFFBC2EB)
val MintGlow = Color(0xFF84FAB0)
val SkyGlow = Color(0xFF8FD3F4)
val LightMintGlow = Color(0xFFC6FFDD)
val LimeGlow = Color(0xFFD4FC79)

val LightWhite=Color(0xFFE2DFD2)

val CardColor1= Color(red = 156, green = 106, blue = 249)
val CardColor2= Color(red = 249, green = 218, blue = 115)
val CardColor3= Color(red = 250, green = 130, blue = 130)
val CardColor4= Color(red = 253, green = 67, blue = 130)

val CouponColor1=Color(0xFFfffdd0)
val CouponColor2=Color(0xFFffeab1)
val CouponColor3=Color(0xFFffd39b)
val CouponColor4=Color(0xFFffb994)

val CouponColor5=Color(0xFF3f00ff)
val CouponColor6=Color(0xFfb067ff)
val CouponColor7=Color(0xFF0000ae)
val CouponColor8=Color(0xFFad64ff)
val CouponColor9=Color(0xFF3400f9)
val CouponColor10=Color(0xFF3b9cb9)
